...
import {Menu, X, PenSquare, Mountain, User, Settings, LogOut, Clock, Calendar, ArrowUpDown} from "lucide-react"
...
export default function BlogListPage() {
  ...
  // Filter by category
  let filteredPosts = selectedCategory === "All" ? blogPosts : blogPosts.filter(post => post.category === selectedCategory)
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {filteredPosts.map(post => (
              <div key={post.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden">
                <div className="p-6">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <h2 className="text-2xl font-bold text-gray-900 mb-2 hover:text-emerald-600 transition-colors cursor-pointer">{post.title}</h2>
