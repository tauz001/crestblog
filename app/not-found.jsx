      ...
      <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Link href={"/"} className="flex items-center justify-center space-x-2 bg-emerald-600 text-white px-8 py-3 rounded-lg hover:bg-emerald-700 transition-colors text-lg font-medium shadow-lg">
              <Home className="w-5 h-5" />
              <span>Go to Home</span>
            </Link>
            <Link href={"/blogs"} className="flex items-center justify-center space-x-2 bg-white text-emerald-600 px-8 py-3 rounded-lg hover:bg-gray-50 transition-colors text-lg font-medium border-2 border-emerald-600">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/" className="flex items-center space-x-3 p-4 rounded-lg hover:bg-emerald-50 transition-colors group">
              ...
              <Link href="write" className="flex items-center space-x-3 p-4 rounded-lg hover:bg-emerald-50 transition-colors group">
                <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center group-hover:bg-emerald-200 transition-colors">
              ...
              <Link href="/blogs" className="flex items-center space-x-3 p-4 rounded-lg hover:bg-emerald-50 transition-colors group">
                <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center group-hover:bg-emerald-200 transition-colors">
              ...
              <Link href="/profile" className="flex items-center space-x-3 p-4 rounded-lg hover:bg-emerald-50 transition-colors group">
                <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center group-hover:bg-emerald-200 transition-colors">
          ...
          {/* Back Button */}
          <Link href={"/"} className="mt-8 flex items-center space-x-2 text-gray-600 hover:text-emerald-600 transition-colors mx-auto">
